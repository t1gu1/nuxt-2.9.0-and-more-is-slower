<template>
    <Container padding>
        <PageTitle>Menu 1 Page title</PageTitle>
        <PageTitle tag="h2">Lorem ipsum 2</PageTitle>
        ...
        <el-form ref="form" class="sales-page" :model="formStructure" label-width="120px" label-position="top">
            <InputTable :form-structure="formStructure">
                <template v-slot:footer>
                    <el-button>Lorem ipsumLorem ipsum</el-button>
                </template>
            </InputTable>

            <PriceTabs title="Lorem ipsumssss" :options="options" />
